...
\noindent
\textit{\color{blue} comments are in blue}

\noindent
\textit{\color{red} sections in red are incomplete and should be skipped}
...
require that their jobs $F_{k} = \{ J_{k}(1), \dots, J_{k}(n_{k})\}$ are processed
in the order
\begin{align*}
J_{k}(1) \rightarrow{} J_{k}(2) \rightarrow{} \dots \rightarrow{} J_{k}(n_{k}) ,
\end{align*}
such that $J_{k}(m)$ denotes the $m$'th job of family $k$.
