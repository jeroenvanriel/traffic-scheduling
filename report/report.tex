...
A more general version of this theorem, without Assumption~\ref{assump1}, was
proven by Limpens~\cite{limpensOnlinePlatoonForming2023}.
...
\section{Online Single Intersection Scheduling}

We need to reconsider assumption~\ref{assump2} because it becomes relevant in
the online setting. Smaller release dates $r_{j}$ provides information to the
controller earlier on.
