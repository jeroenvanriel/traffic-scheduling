...
\usepackage{xstring}
\setlength{\marginparwidth}{3cm} % more room
\usepackage{etoolbox}
...
\newcommand{\mytitle}{%
  ...
  {\Large\bf as a tool for solving}\\[0.2em]
  {\huge\bf Combinatorial optimization problems}\\[0.0em]
  {\Large\bf found in the context of}\\[0.2em]
...
\comment[noline]{[Added] this part.}
...
successive vehicles on the same route, see also~\Cref{lemma:arrivals}.
...
satisfy.\comment{Move to scheduling section, show it transfers to a policy rule.}
%
