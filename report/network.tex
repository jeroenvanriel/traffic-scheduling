...
The general two-stage decomposition for the single intersection extende to the
present model. Let for each pair $(i,v)$ of some vehicle $i \in \mathcal{N}$ and
an intersection $v \in V_{r(i)}$ along its route, let
\begin{align*}
