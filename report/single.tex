...
Figure~\ref{fig:intersection_illustration}, which has two incoming lanes. The corresponding two routes
...
We let the lanes be identified by indices $\mathcal{R} = \{ 1, 2 \}$. We
identify vehicles by their route and by their relative order on this route, by
