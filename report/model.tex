...
\textit{disjunctive graph} \textit{\color{blue}cite! is there a more accessible reference than this original french paper?}. Let
...
\textit{\color{blue}see example illustration of disjunctive graph}
...
% source, sink and weights corresponding to processing time
