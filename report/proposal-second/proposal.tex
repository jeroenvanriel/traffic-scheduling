...
\begin{itemize}
  ...
  \item (3 weeks) \textbf{Imitation learning.} Fit the policy to expert demonstration
...
parameterized constructive heuristic that is fitted using imitation learning. We
