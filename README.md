...
Suppose you can control every autonomous vehicle in a certain neighborhood of tightly interconnected intersections, maybe something like downtown Manhattan, if you like. Assume that every driver (or rather, *passenger* in this scenario) has communicated their next destinations, then how would we have to guide all vehicles in order to optimize measures such as overall travel time and energy efficiency?

Rapid advances in autonomous vehicle technology keeps increasing the relevance of this kind of question, to which there are many modeling facets. This project focuses on the following two aspects:
