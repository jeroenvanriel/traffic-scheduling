...
def train(model_path, K, instance_generator, switch_over, horizon, args=Args()):
    seed = args.seed
    ...
    # env setup
    envs = gym.vector.SyncVectorEnv([make_env(args.env_id, K, instance_generator, switch_over, horizon, seed)])
